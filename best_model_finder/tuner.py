...
class Model_Finder:
    ...
    def __init__(self, file_object, logger_object):
        ...
        :param file_object: file to log messages
        :param logger_object: logger object to log messages in file
        """
        self.file_object = file_object
        self.logger_object = logger_object
        self.clf = RandomForestClassifier()     # Create random forest classifier
        self.xgb = XGBClassifier(objective='binary:logistic')   # create xgboost classifier
    ...
    def get_best_params_for_xgboost(self, train_x, train_y):
        ...
        :param train_x, :param train_y : training data
        """
