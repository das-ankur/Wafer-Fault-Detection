...
class prediction:
    """
    The class is used to create predictions.
    """
    def __init__(self, path):
        """
        Description: Constructor
        :param path: path of the prediction files
        """
    ...
    def predictionFromModel(self):
        """
        Description : Create predictions from training data
        :return: None
        :output: Create prediction file
        """
        try:
